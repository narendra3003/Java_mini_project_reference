...
create table Transaction_category(category_id int(2) primary key,categoryname varchar(20),description varchar(50));
insert into transaction_category values(501,'xyz','Online payment'),(502,'abc','Offline payment');

create table transactions(transaction_id int(5),transactiondate DATE,amount int(4),transactiontype varchar(10),categoryname varchar(15),category_id int(2),user_id int(2),foreign key (category_id) references Transaction_category(category_id),foreign key (user_id) references User(user_id));
insert into transactions values(401,'2023-08-17',40000,'Expense','School',501,101),(402,'2023-08-18',20000,'Expense','Food',502,102);
...
create table budget(budget_id int(2)primary key,elimit int(4),category_id int(3),category_name varchar(15),user_id int(2),foreign key (category_id) references Transaction_category(category_id),foreign key (user_id) references User(user_id));
insert into budget values(501,70000,501,'Transportation',101),(502,75000,502,'Food',102);
